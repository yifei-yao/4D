...
#ifndef INC_4D_EVAL_H
#define INC_4D_EVAL_H

#include "board.h"
#include <array>

// Using PeSTO's Evaluation Function
...
namespace eval {
  ...
  static constexpr std::array<int, 6> mg_value = {82, 337, 365, 477, 1025, 0};
  static constexpr std::array<int, 6> eg_value = {94, 281, 297, 512, 936, 0};
  ...
  static constexpr std::array<int, 12> game_phase_inc = {0, 0, 1, 1, 1, 1, 2,
                                                         2,
                                                         4, 4, 0, 0};
}
